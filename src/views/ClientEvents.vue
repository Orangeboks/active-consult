            ...
            <v-card>
                ...
                <v-card-text class="mt-4">
                    ...
                    <v-row class="mt-4">
                        ...
                        <v-col cols="12">
                            <v-autocomplete :items="getUsers" v-model="event.user" return-object item-text="client_info.companyName" placeholder="Select User" color="info" outlined hide-details></v-autocomplete>
                        </v-col>
                        <v-col cols="12">
