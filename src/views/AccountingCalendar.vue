        ...
        <v-container class="my-5">
            <v-row align="center">
                <v-col cols="8">
                    ...
                    <h2 v-if="$vuetify.breakpoint.mdAndUp" class="black--text">Accounting Calendar</h2>
                    <h4 v-if="$vuetify.breakpoint.smAndDown" class="black--text">Accounting Calendar</h4>
                </v-col>
            ...
            <v-tabs v-model="tab" color="grey" active-class="black--text" height="40" slider-size="3" slider-color="yellow darken-3" v-if="!loading && events.length">
                <v-tab>All Events</v-tab>
                <v-tab>By Client</v-tab>
                <v-tab>Waiting Approval <v-badge color="yellow darken-2" inline :content="10"></v-badge></v-tab>
                <!-- <v-tab>Today</v-tab>
            ...
            <v-tabs-items v-model="tab" v-if="!loading && events && events.length">
                <v-tab-item>
                    <EventStats :events="events" class="mt-5" />
                    <AllEvents :headers="headers" :events="events" @updateStatus="updateStatus" />
                </v-tab-item>
                <v-tab-item>
                    <EventStats :events="events" class="mt-5" />
                    <ClientList :events="events" />
                </v-tab-item>
                <v-tab-item>
                    <h1 class="text-center my-5">Page Not Developed yet.</h1>
                </v-tab-item>
...
import EventStats from '@/components/AccountingCalendar/EventStats'
import AllEvents from '@/components/Events/AllEvents'
import ClientList from '@/components/Events/ClientList'
